...
const Login = () => {
  ...
  return (
    <div className='overflow-hidden bg-gradient-to-tl from-darkPrimary via-primary to-secondary bg-size-300 bg-pos-0 animate-gradient-flow h-screen'>
      <Navbar />
      <div className='flex items-center justify-center mt-36'>
        <div className='w-96 rounded bg-white px-7 py-16'>
